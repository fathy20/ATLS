    ...
    <>
      ...
      <section style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <h2 className="products-title"><strong>أفضل العلامات التجارية</strong></h2>
        </div>
      ...
      <section className="features-section section-dark" id="features">
        <div className="features-header">
          ...
          <h2 className="section-title reveal-text">مميزات <strong>أطلس</strong></h2>
        </div>
      ...
      <section className="contact-section" id="contact">
        <div className="contact-info">
          ...
          <div className="contact-item">
            ...
            <p className="contact-value">طرابلس، الكريمية، بجانب شارع سيدي سليم</p>
          </div>
          <div className="contact-item">
          ...
          <div className="contact-item">
            <p className="contact-label">تابعنا</p>
            <div style={{ display: 'flex', gap: '1rem', marginTop: '0.5rem' }}>
              <a href="https://www.facebook.com/atlas2026/" target="_blank" rel="noopener noreferrer" style={{ color: 'white', transition: 'opacity 0.3s' }} aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.791-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/atlas_ly2026?igsh=MTB1c2RyeGl2ampvcQ==" target="_blank" rel="noopener noreferrer" style={{ color: 'white', transition: 'opacity 0.3s' }} aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.tiktok.com/@atlasly5?_r=1&_t=ZS-93t89GS4fdH" target="_blank" rel="noopener noreferrer" style={{ color: 'white', transition: 'opacity 0.3s' }} aria-label="TikTok">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
